...
{
    public class NeoRenderText : IWindowContent
    {
        ...
        public NeoRenderText(ISpriteFont font, string message, Color color, Vector2 position, bool hasOutline = false,
        ...
        public NeoRenderText(ISpriteFont font, string message, Color color, bool hasOutline = false,
            Color? outlineColor = null) :
        ...
        public NeoRenderText(ISpriteFont font, string message, bool hasOutline = false, Color? textColor = null) :
