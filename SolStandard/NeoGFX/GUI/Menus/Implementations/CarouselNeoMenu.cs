...
{
    public class CarouselNeoMenu : GridNeoMenu
    {
        ...
        private static List<List<MenuOption>> OptionsForOrientation(List<MenuOption> options, Orientation orientation)
        {
            return orientation switch
            {
                ...
                Orientation.Vertical => VerticalNeoMenu.ConvertToVerticalList(options),
        ...
        public static MenuOption GenerateOption(MenuOption.OnConfirm onConfirm, NeoWindow.JuicyWindow juicyWindow,
