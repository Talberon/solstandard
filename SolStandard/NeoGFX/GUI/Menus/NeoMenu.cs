...
{
    public abstract class NeoMenu : IPositionedNeoRenderable
    {
        ...
        protected NeoWindow.JuicyWindow OptionsWindow;
        ...
        protected NeoMenu(List<List<MenuOption>> options, Vector2 centerPosition, int elementSpacing = 0,
        ...
        protected void Reset(List<List<MenuOption>>? newOptions = null)
        {
...

            {
                ...
                var optionContainerWindowContentBuilder = new NeoWindowContentGrid.Builder();
                ...
                NeoWindowContentGrid neoWindowContentGrid = optionContainerWindowContentBuilder
                    .Spacing(elementSpacing)
                    .HorizontalAlignment(alignment)
                    .Build();

                OptionsWindow = new NeoWindow.Builder()
                    .Content(neoWindowContentGrid)
