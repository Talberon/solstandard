...
namespace SolStandard.NeoGFX.GUI
{
    public class WindowContentGrid : IWindowContent
    {
        ...
        private WindowContentGrid(List<List<IWindowContent>> contentGrid, int spacing, HorizontalAlignment alignment,
            Vector2 position)
        {
        ...
        public WindowContentGrid(IWindowContent[,] contentGrid, Vector2? position = null, int spacing = 1,
        ...
        {
            private readonly WindowContentGrid grid;

            public Builder()
            {
                grid = new WindowContentGrid(new IWindowContent[,] {{ }});
            }

            private Builder(WindowContentGrid grid)
            {
                this.grid = grid;
            }

            public static Builder Mutate(WindowContentGrid grid)
            {
            ...
            public WindowContentGrid Build()
            {
                return grid;
            }
        }
